...
class PharmaSop(models.Model):
    ...
    def _check_sop_code_unique(self):
        """Guarantee the SOP Code is a unique serial reference."""
        for rec in self:
    ...
    def action_reset_draft(self):
        """Revert the SOP to Draft for editing without a new version."""
        self._check_pharma_group(
            'pharmaceutical_base.group_pharma_role_qa',
            _('Only QA can return an SOP to draft.'),
        )
    ...
    def action_view_trainings(self):
        """Open all training records related to this SOP."""
        return {
