...
class PharmaQcTestOrder(models.Model):
    ...
    def action_approve(self):
        ...
        for rec in self:
            ...
            # status becomes 'passed'; now move the released stock physically.
            rec._pharma_dispose('release')
    ...
    def action_reject(self):
        ...
        for rec in self:
            ...
            rec._pharma_dispose('reject')

    def _pharma_dispose(self, disposition):
        """Move the tested lot out of Quarantine per the QC disposition."""
        self.ensure_one()
        # Only incoming (raw-material) receipts land in the Quarantine location
        # and need the quarantine-to-release/reject transfer. Finished-goods and
        # in-process QC have no such physical disposition move.
        ...
        if disposition == 'release':
            dest = company.pharma_released_location_id
        else:
