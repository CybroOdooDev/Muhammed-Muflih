...
export class FlynovaTheme extends Component {
    ...
    _initScrollHeader() {
        ...
        const onScroll = () => {
            ...
            // begins — eliminates the transparent "stuck" window on the hero.
    ...
    _initActiveNavLinks() {
        const navLinks = document.querySelectorAll(
            "header#top .top_menu a.nav-link[href], #top_menu_collapse_mobile a.nav-link[href]"
        );
        if (!navLinks.length) {
            return;
        }
