...
class ProductTemplate(models.Model):
    ...
    flynova_listing_type = fields.Selection(
        ...
        help='Used by the Flynova theme to decide whether this product '
    ...
    included_details = fields.Text(
        string='Included Details', help='List items separated by new lines')
    excluded_details = fields.Text(
        string='Excluded Details', help='List items separated by new lines')
