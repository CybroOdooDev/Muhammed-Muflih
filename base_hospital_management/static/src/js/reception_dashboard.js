...
class ReceptionDashBoard extends Component{
    setup() {
        this.patient_creation = signal.ref();
        this.inpatient = signal.ref();
        this.out_patient = signal.ref();
        this.rd_buttons = signal.ref();
        this.room_ward = signal.ref();
        this.ward = signal.ref();
        this.room = signal.ref();
